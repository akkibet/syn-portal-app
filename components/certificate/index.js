...
export default function CertificateComp(props) {
  return (
    <div className="overflow-y-auto lg:w-full w-11/12 lg:mx-auto">
      <div className="flex lg:w-3/4 w-11/12 mx-auto mt-5">
                  ...
                  return (
                    <tr key={index}>
                      ...
                      <td className="border py-5 text-lg">
                        {moment(cert.awardedOn).format("MMM Do YY")}
                      </td>
                      <td className="border py-5 text-lg">
                        {moment(cert.expiredOn).format("MMM Do YY")}
                      </td>
                      ...
                      <td className="border py-5 text-lg">
                        {cert.status === "PENDING" ? (
                          <a
                            ...
                            onClick={() =>
                              props.goToConfirmCertificate(cert._id)
                            }
                          >
                            Confirm
                          </a>
