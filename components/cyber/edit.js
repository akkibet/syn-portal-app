...
export default function EditCyberComp(props) {
    const { name, desc, path, date, setName, setDesc, setPath, setDate } = props;
    const { register, handleSubmit, trigger, formState: { errors }, reset } = useForm();
    
    const onSubmit = async (data) => {
        props.editLab(props.id, props.counter, data);
    }
    return (
        <div className="mt-5 p-4 w-4/5 mx-auto bg-gray-200 border-2 border-gray-500 rounded-lg">
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="flex lg:flex-row flex-col w-full justify-between">
                    <div className="flex-1 mr-5">
                        <div className="flex flex-col">
                            <div className="flex-1">
                                <p className="text-2xl font-bold">Edit Cyber Details</p>
                            </div>
                            <div className="flex-1">
                    ...
                    <div className="flex-1 lg:ml-5 lg:mt-0 mt-5">
                        <div className="flex flex-col">
                            <div className="flex-1">
                                <button
                                    type="submit"
